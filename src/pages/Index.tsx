...
const Footer = () => {
  ...
  return (
    <footer className="text-center py-4 border-t text-slate-600 text-sm bg-white/60 backdrop-blur-sm">
      © {year} Marcel J. Sparks — Built with React ⚛️
    </footer>
  );
};
      ...
      <main className="flex-grow">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              Built by Marcel J. Sparks - Future Software Developer
            </p>
          </div>
